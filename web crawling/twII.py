...
url = 'https://finance.yahoo.com/quote/%5ETWII/history?period1=978307200&period2=1640995200&interval=1mo&filter=history&frequency=1mo&includeAdjustedClose=true'
...
# find date
day = twII.find_all('td', class_="Py(10px) Ta(start) Pend(10px)")

# find price and vol
price = twII.find_all('td', class_="Py(10px) Pstart(10px)")
...
twII_table.to_csv('data analysis_final project/twII_data.csv', index=False)
